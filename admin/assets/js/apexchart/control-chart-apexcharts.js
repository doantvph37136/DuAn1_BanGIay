...
function chartD() {
  var options = {
    ...
    series: [
      {
        name: "Revenue",
        data: [9, 3.1, 4.0, 10.1, 4.0, 3.6, 3.2, 2.3, 1.4, 0.8, 0.5, 0.2],
      },
    ],
    xaxis: {
      categories: [
...
function chartH() {
  ...
  var chart = new ApexCharts(document.querySelector("#chartH"), options);
...
function chartJ() {
  ...
  var chart = new ApexCharts(document.querySelector("#chartJ"), options);
...
function chartK() {
  ...
  var chart = new ApexCharts(document.querySelector("#chartK"), options);
...
function chartL() {
  ...
  var chart = new ApexCharts(document.querySelector("#chartL"), options);
...
function chartGG2() {
  ...
  var chart = new ApexCharts(document.querySelector("#chartGG2"), options);
...
function chartGG3() {
  ...
  var chart = new ApexCharts(document.querySelector("#chartGG3"), options);
