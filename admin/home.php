                    ...
                    <div class="colxl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-title-wrapper">
                            <div class="page-title-box">
                                <h4 class="page-title bold">Admin</h4>
                            </div>
                            <div class="breadcrumb-list">
                                <ul>
                                    <li class="breadcrumb-link">
                                        <a href="index.php?act=/"><i class="fas fa-home mr-2"></i>Trang Chủ</a>
                                    </li>
                        ...
                        <div class="card ad-info-card">
                            <div class="card-body dd-flex align-items-center">
                                ...
                                <div class="icon-info-text">
                                    ...
                                    <h4 class="ad-card-title">300.000.000VNĐ</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <table class="table table-styled mb-0">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <th><a href="index.php?act=suatk&id=<?php echo $tk['id'] ?>"><button style="red">SUA</button></a> <a href="index.php?act=deletetk&id=<?php echo $tk['id'] ?>"><button style="red" onclick="return confirm('BẠN MUỐN XÓA DANH MỤC NÀY ?')">XÓA</button></a></th>
